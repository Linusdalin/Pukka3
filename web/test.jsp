...
<title>Pukka 3 Demo</title>    <!-- Bootstrap Core CSS -->
...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/home">Pukka 3 Demo</a>
            </div>
            <!-- /.navbar-header -->
 ...
 <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Static<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                             <li><a href="/page?page=DemoPage"> Other</a></li>
                             <li><a href="/page?page=DemoPage"> Other2</a></li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>                        <li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Demo Dashboard Page</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
    ...
    <script src="adminCommon/bower_components/morrisjs/morris.min.js"></script>
            <script src="adminCommon/js/morris-data.js"></script>
